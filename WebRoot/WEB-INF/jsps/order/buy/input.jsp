			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="648px">
							<s:select id="supplierId" list="#suppliers" headerKey="" headerValue="-----请选择-----" name="query.supplierId" cssStyle="width:300px"  listKey="supplierId" listValue="name"></s:select>
			...
			<div class="square-order">
				<table id="order" width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<tr id="defaultTr" align="center" bgcolor="#FFFFFF">
						...
						<td class="total" align="right" trTotal="">100.00&nbsp;元</td>
						<td>
