			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<s:select list="#suppliers" name="query.supplierId" cssClass="kuan" headerKey="" headerValue="----请-选-择----" listKey="supplierId" listValue="name"></s:select>
						</td>
						<td width="60">类别名称:</td>
						<td width="149">
						...
						<td width="70"><a id="addPt" href="javascript:void(0)"><img
